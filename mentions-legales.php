...
<?php if($_SESSION["Language"] == "ar"){?><link rel="stylesheet" href="css/rtl.css"><?php } ?>
    <title>Mentions Légales - Je viens d'ailleurs</title>
    ...
    <main>
        <section class="mentions">
            <div class="text">
                ...
                <p class="legal-text"><strong>Je viens d'ailleurs</strong>, 23 Maufaire 35310 Mordelles</p> 
                <h2 class="merriweather" ><?php echo _("Directeur de la publication") ?></h2> 
                <p class="legal-text">Martin OMNES</p>
                <h2 class="merriweather" ><?php echo _("Droit d’accès") ?></h2> 
                <p class="legal-text"><?php echo _("En application de la loi Informatique et liberté, vous disposez d’un droit d’accès, de rectification, de modification et de suppression concernant des données qui vous concernent personnellement. Ce droit peut être exercé par voie électronique ou par courrier postal, daté et signé, accompagné d'une copie d’un titre d’identité.") ?></p>
                <h2 class="merriweather" ><?php echo _("Politique de confidentialité") ?></h2> 
                <p class="legal-text"><?php echo _("Les informations personnelles collectées ne sont en aucun cas confiées à des tiers.") ?></p>
                <h2 class="merriweather " ><?php echo _("Propriété intellectuelle") ?></h2> 
                <p class="legal-text"><?php echo _("Tout le contenu de notre site, incluant, de façon non limitative, les graphismes, images, textes, vidéos, animations, sons, logos et icônes, sont la propriété exclusive de l'éditeur du site, à l’exception des marques, logos ou contenus appartenant à d’autres organisations.") ?></p>
                <h2 class="merriweather" ><?php echo _("Hébergeur") ?></h2> 
                <p class="legal-text"><strong>Je viens d'ailleurs </strong> <?php echo _("est hébergé par o2switch, 222-224 Boulevard Gustave Flaubert, 63000 Clermont-Ferrand - Capital de 100000€ - Siret 510 909 80700024") ?></p>
            </div>
        </section>
    </main>
